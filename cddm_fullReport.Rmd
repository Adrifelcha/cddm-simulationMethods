...
In this document, we present a comparison between different sampling algorithms that generate data under the CDDM. We will describe how each of these algorithms work and discuss the comparison method by generating `n = 5000` bivariate observations using the same set of arbitrary parameter values:
...
Each pair of observations is obtained by emulating the random walk process described by the CDDM.
