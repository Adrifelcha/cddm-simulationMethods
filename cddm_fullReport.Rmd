...
scatterplot3d(X2.RW$bivariate.data[,1], X2.RW$bivariate.data[,2],
              RW.eCDF2,  pch=16, cex.symbols = 0.5, color = col.RW(0.4),
              xlab = "", ylab = "", zlab = "")
mtext("Random Walk algorithm", f=2)
mtext("Choices", side=1, line=0.5)
mtext("RTs", side=4, line=-1, adj=0)
scatterplot3d(X2.Reject[,1],X2.Reject[,2],Reject.eCDF2, pch=16,
              cex.symbols = 0.5, color = col.Reject(0.4), 
              xlab = "", ylab = "", zlab = "")
mtext("Rejection sampling algorithm", f=2)
mtext("Choices", side=1, line=0.5)
mtext("RTs", side=4, line=-1, adj=0)
scatterplot3d(X2.Metro[,1],X2.Metro[,2],Metro.eCDF2, pch=16,
              cex.symbols = 0.5, color = col.Metro(0.4), 
              xlab = "", ylab = "", zlab = "")
mtext("Metropolis sampling algorithm", f=2)
mtext("Choices", side=1, line=0.5)
mtext("RTs", side=4, line=-1, adj=0)
scatterplot3d(X2.invCDF[,1],X2.invCDF[,2],invCDF.eCDF2, pch=16,
...
```{r}
getDifferences(RW.eCDF2,RW.tCDF2)
getDifferences(Reject.eCDF2,Reject.tCDF2)
getDifferences(Metro.eCDF2,Metro.tCDF2)
getDifferences(invCDF.eCDF2,invCDF.tCDF2)
```
