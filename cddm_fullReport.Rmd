...
forceRun <- TRUE    # Whether we re-run all chunks, ignoring past saved results
...
# The r-chunk above is actually just for display. This is where the samples are actually
# generated or loaded from previously-saved output files, as indicated in the opening chunk.
if(forceRun|!file.exists("./tmp/X.Reject.RData")){
      start_time <- Sys.time()
      X.Reject <- sample.Reject.cddm(n,par,max.RT,plot=TRUE)
      end_time <- Sys.time()
...
# The r-chunk above is actually just for display. This is where the samples are actually
# generated or loaded from previously-saved output files, as indicated in the opening chunk.
if(forceRun|!file.exists("./tmp/X.Metro.RData")){
      start_time <- Sys.time()
      X.Metro <- sample.Metropolis.cddm(n,par,max.RT,plot=TRUE)
      end_time <- Sys.time()
...
# The r-chunk above is actually just for display. This is where the samples are actually
# generated or loaded from previously-saved output files, as indicated in the opening chunk.
if(forceRun|!file.exists("./tmp/X.invCDF.RData")){
      start_time <- Sys.time()
