...
source("./code/cddm/dCDDM_aux.R") # CDDM likelihood function - Needed for ALL algorithms
source("./code/cddm/dCDDM.R") # CDDM likelihood function - Needed for ALL algorithms
source("./code/cddm/pCDDM_aux.R") # Needed for approximating the CDF under the CDDM
...
X.Reject <- rCDDM_Reject(n,par,plot=TRUE)
```
