---
title: "A comparison between different types of sampling algorithms for the CDDM in R"
...
To create Fig 1, we will define an arbitrary set of parameter values and sample size of 5000. This parameter set will be used throughout the document to illustrate the different sampling algorithms.
...
set.seed(777)
data_fig1 <- plot.CDDM_Fig1(trials = 1000,par,return.Data = TRUE)
```
