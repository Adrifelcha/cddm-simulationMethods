...
rCDDM_Reject_rectUniform <- function(n, par, plot=FALSE){
  ...
  if(plot){
    ...
    pdf(file = here("results", "show_Reject_rectUniform.pdf"), width = 10, height = 10)
    nSupp <- 100; nLines <- 30
...
#rCDDM_Reject_rectUniform(n=10000, par=list(mu1=1, mu2=1, tzero=0, boundary=1), plot=TRUE)